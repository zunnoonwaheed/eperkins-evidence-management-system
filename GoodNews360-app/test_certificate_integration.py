"""
Integration tests for TheGoodNews360 Eperkins Certificate API
...
def test_payload_structure():
    ...
    test_lead = {
        ...
        "Owe Back Taxes": "Yes — more than $10,000",
        "Monthly Bill Reduction": "Insurance (health, auto, home)",
        "Contact Consent": "yes",
    ...
    if "lead_data" in payload:
        ...
        lead_required = ["firstName", "lastName", "email", "phone", "form_answers"]
    ...
    # Check TheGoodNews360-specific form fields
    if "lead_data" in payload and "form_answers" in payload["lead_data"]:
        form_answers = payload["lead_data"]["form_answers"]
        expected_fields = ["zip_code", "age_range", "home_status", "household_income",
                          "owe_back_taxes", "monthly_bill_reduction"]
        for field in expected_fields:
            if field in form_answers:
                print(f"✓ form_answers.{field}: present")
    ...
    print(f"   Company Key: {payload['company_key']}")
...
def test_certificate_creation():
    ...
    test_lead = {
        ...
        "Email": "integration-test-goodnews360@example.com",
        "ZIP Code": "90210",
        "Age Range": "55 – 64",
        "Home Status": "Own",
        "Household Income": "$100,000 or more",
        "Owe Back Taxes": "I'm not sure",
        "Monthly Bill Reduction": "Insurance (health, auto, home)",
        "Contact Consent": "yes",
    ...
    recording_url = "https://storage.googleapis.com/test-bucket/videos/goodnews360-integration-test.mp4"
    recording_storage_path = "gs://test-bucket/videos/goodnews360-integration-test.mp4"

    payload = build_certificate_payload(
        lead=test_lead,
        recording_id="goodnews360-test-rec-001",
        recording_url=recording_url,
        recording_storage_path=recording_storage_path,
        video_generated_at=get_current_utc_iso()
    )
...
def run_all_tests():
    ...
    print("=" * 60)
    print("TheGoodNews360 Certificate Integration Tests")
    print("=" * 60)
